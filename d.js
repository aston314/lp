    ...
    function DOUBAN(object) {
      ...
      this.append = function (data) {
        ...
        data.subjects.forEach(function (element) {
          ...
          card.find('.card__img').attr('src', element.cover.replace('s_ratio_poster','l_ratio_poster'));
           if (element.rate){
...
/*              console.log(find)
    ...
    function startDOUBAN() {
      ...
      var catalogs = [{
        ...
        title: '热门电视剧',
        url: 'https://movie.douban.com/j/search_subjects?type=tv&tag=%E7%83%AD%E9%97%A8&sort=time&page_limit=20&page_start=0'
      }, {
        title: '美剧',
