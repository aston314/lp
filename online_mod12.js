 //01.08.2022 - Rezka next/prev episode
...
(function () {
  ...
  function kunyu77(component, _object, rule) {
    ...
    this.search = function (_object, kinopoisk_id) {
      ...
      url1 = url1.replace('#msearchword',encodeURIComponent(object.movie.title));
    //   network.silent('https://raw.githubusercontents.com/aston314/lampa/main/test.json', function (json) {
    //    if (json) {
    //       parse(json);
    //     } else component.emptyForQuery(select_title);
    ...
    function parse(json) {
        //console.log(json.data[0].videoUrls)
  ...
  function component(object) {
    ...
    var filter_sources = ['酷云','videocdn', 'rezka', 'kinobase', 'collaps', 'cdnmovies', 'filmix', 'hdvb']; // шаловливые ручки
