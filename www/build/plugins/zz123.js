(function () {
    ...
    function ZZMUSIC(object) {
        ...
        this.append = function (data,append) {
            ...
            data.data.forEach(function (element,i) {
                ...
                card.find('.card__img').attr('src', 'https://zz123.com' + element.pic.replace('w_50,h_50,','w_200,h_200,'));
                                    ...
                                    network["native"]('https://zz123.com/myajax/', function (json) {
                                        ...
                                        if (json.status == 200) {
                                            ...
                                            if (playlistname.length) {
                                                _this3.popupWindows_(playlistname, sel.url, 3, "favorite", "选择歌单")
                                            }
                                        } else {
                                            Lampa.Noty.show(json.msg);
                                            Lampa.Controller.toggle('content');
            ...
            info.find('.open--favorite').on('hover:enter hover:click', function () {
                ...
                network["native"]('https://zz123.com/myajax/', function (json) {
                    ...
                    if (json.status == 200) {
                        ...
                        if (playlistname.length) {
                            popupWindows(playlistname, 'https://zz123.com/myajax/?act=sheetsong&sheettype=0&lang=&page=1&sheetid=', 3, "favorite", "收藏")
                        }
                    } else {
                        Lampa.Noty.show(json.msg);
                        Lampa.Controller.toggle('content');
    ...
    function aboutSite() {
        var displayModal = function displayModal() {
            var html = Lampa.Template.get('about_music');
            Lampa.Modal.open({
                title: '',
                html: html,
                size: 'small',
    ...
    function startZZMUSIC() {
        ...
        Lampa.Template.add('about_music', "<div class=\"account-add-device\">\n    <img src=\"data:image/png;base64,\" class=\"account-add-device__qr\" />\n\n    <div class=\"about\">\n        微信扫一扫访问网站同步听歌\n    </div>\n\n    \n</div>");
    ...
    Lampa.Settings.listener.follow('open', function (e) {
      if (e.name == 'mod_zz123') {
        ...
        var zz123_about = e.body.find('[data-name="online_mod_zz123_about"]');
        zz123_about.unbind('hover:enter').on('hover:enter', function () {
            aboutSite();
        });
