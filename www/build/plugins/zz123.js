                ...
                Lampa.Select.show({
                    ...
                    onSelect: function onSelect(a) {
                        if (a.title == '歌单') {
                            ...
                            popupWindows(playlistname, "https://zz123.163.com/api/playlist/list/?cat=", 5, "playlist", "歌单") 
                        } else {
                            Lampa.Activity.push({
                                url: a.url,
                                title: '音乐 - ' + a.title,
                ...
                Lampa.Select.show({
                    ...
                    onSelect: function onSelect(a) {
                        if (a.title == '分类') {
                            ...
                            popupWindows(playlistname, "https://music.163.com/api/playlist/list/?cat=", 5, "playlist", "分类") 
                        } else {
                            Lampa.Activity.push({
                                url: a.url,
                                title: '音乐 - ' + a.title,
