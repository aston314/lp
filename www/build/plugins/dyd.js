(function () {
    ...
    function DYD(object) {
        ...
        this.card = function (str) {
            ...
            // };
            //console.log(page)
            $('.thumbnail-link', str).each(function (i, html) {
                //if ($('.tgme_widget_message_text.js-message_text', html).text().match(/https:\/\/www\.aliyundrive\.com\/s\/([a-zA-Z\d]+)/)) {
                    card.push({
                        ...
                        title: $('.thumbnail-wrap img', html).attr('alt').substring(0, $('.thumbnail-wrap img', html).attr('alt').indexOf(' ')),
                        original_title: '',
                        title_org: '',
                        ...
                        img: $('.thumbnail-wrap img', html).attr('src').replace('243','270').replace('156','405'),
                        quantity: ' ',
                        year: '',
    ...
    {
        title: '首页',
        url: 'http://www.dydhhy.com/'
    },
    {
        title: '电影',
        url: 'http://www.dydhhy.com/tag/movie/'
    },
    {
        title: '剧集',
        url: 'http://www.dydhhy.com/tag/tv/'
    },
    {
        title: '美剧',
        url: 'http://www.dydhhy.com/tag/%E7%BE%8E%E5%89%A7/'
    },
    {
        title: '日剧',
        url: 'http://www.dydhhy.com/tag/%e6%97%a5%e5%89%a7/'
    },
    {
        title: '英剧',
        url: 'http://www.dydhhy.com/tag/%E8%8B%B1%E5%89%A7/'
    },
    {
        title: '韩剧',
        url: 'http://www.dydhhy.com/tag/%E9%9F%A9%E5%89%A7/'
    },
    {
        title: '2023年',
        url: 'http://www.dydhhy.com/tag/2023/'
    }, {
        title: '2022年',
        url: 'http://www.dydhhy.com/tag/2022/'
    }, {
        title: '2021年',
        url: 'http://www.dydhhy.com/tag/2021/'
    }];

    function startDYD() {
        window.plugin_dyd_ready = true;
        Lampa.Component.add('dyd', DYD);

        function addSettingsDYD() {
            ...
            var menu_item = $('<li class="menu__item selector focus" data-action="channel"><div class="menu__ico">' + ico + '</div><div class="menu__text">DYD</div></li>');
        ...
        if (window.appready) addSettingsDYD()
        else {
            Lampa.Listener.follow('app', function (e) {
                if (e.type == 'ready') addSettingsDYD()
            })
        }
    ...
    if (!window.plugin_dyd_ready) startDYD();
