(function () {
    ...
    function MUSIC(object) {
        ...
        this.create = function () {
            ...
            network["native"]('https://music.163.com/api/cloudsearch/pc', this.build.bind(this), function () {
        ...
        this.append = function (data) {
            ...
            data.result.songs.forEach(function (element) {
                ...
                card.find('.card__img').attr('src', element.cover||element.img||element.pic||element.al.picUrl);
