(function () {
    ...
    function xiaozhitiao(object) {
      ...
      var items = [];
      var html = $('<div></div>');
      var body = $('<div class="freetv_xzt category-full"></div>');
      var info;
      var last;
      var waitload;
