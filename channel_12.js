            ...
            str = str.replace(/\n/g, '');
                ...
                $('div.tgme_widget_message_wrap.js-widget_message_wrap',str).each(function (i, html) {  
                    ...
                    card.push({
                        ...
                        url: $('.tgme_widget_message_text.js-message_text', html).text().match(/https:\/\/www\.aliyundrive\.com\/s\/([a-zA-Z\d]+)/)?$('.tgme_widget_message_text.js-message_text', html).text().replace(/4K|1080|2160/g,' ').match(/https:\/\/www\.aliyundrive\.com\/s\/([a-zA-Z\d]+)/)[0]:'',
