      ...
      this.start = function (first_select) {
        ...
        if (first_select) {
          ...
          if (typeof cont !== "undefined") {
            //console.log(Lampa.Storage.get('online_mod_choice_first_order_'),cont.order,cont.last_viewed,first_order)

            //if (first_order === false ){
              if (Lampa.Storage.get('online_mod_choice_first_order_') === cont.order){
