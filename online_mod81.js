...
(function () {
    ...
    function kunyu77(component, _object, rule) {
          ...
          return new Promise(function (resolve, reject) {
            ...
            cordovaHTTP.get(url, {},{
              ...
              try {
                ...
                if (json1.msg !== '获取成功' || json1.msg == '非法请求' || json1.data.episodes.length == 0) {
                  component.emptyForQuery(select_title)
                } else {
                  parse(json1);
                };
      ...
      this.search = function (_object, kinopoisk_id) {
        ...
        var url;
        kinopoisk_id === parseInt(kinopoisk_id, 10) ? url='http://api.kunyu77.com/api.php/provide/videoPlaylist?ids='+kinopoisk_id+'&version=2.0.4&sj=1662003259': url= 'http://api.kunyu77.com/api.php/provide/searchVideo?searchName='+encodeURIComponent(object.movie.title);
                  ...
                  if (json) {
                      ...
                      if (json.data.length !== 0) {
                          ...
                          if (json.data.length == 1) {
                              ...
                              url = 'http://api.kunyu77.com/api.php/provide/videoPlaylist?ids=' + id+'&version=2.0.4&sj=1662003259';
                              // network.silent(url, function (json) {
                              //     if (json) {
                              //         if (json.data.episodes.length == 0) {
                              //             component.emptyForQuery(select_title)
    ...
    function component(object) {
      ...
      var filter_sources = ['酷云', '阿里云盘', '小纸条', '霸王龙压制组', 'videocdn', 'rezka', 'kinobase', 'collaps', 'cdnmovies', 'filmix', 'hdvb', 'videoapi']; // шаловливые ручки
