(function () {
    ...
    if (Lampa.Storage.get('json_use')) {
        new Lampa.Reguest().silent(Lampa.Storage.field('web_rule_json'), function (json) {
            catalogs = json;
        }, function (a, c) {
