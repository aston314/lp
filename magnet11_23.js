        ...
        data.data.forEach(function (element) {
          ...
          card.on('hover:long', function (target, card_data) {
            ...
            if (window.fetch) {
              ...
              //   //console.log('error :(');
              // });
              // cordovaHTTP.postJson('https://api-drive.mypikpak.com/drive/v1/files', postData_, {
              //   "content-type": "application/json;charset=utf-8",
              //   authorization: info.loginInfo.token_type + ' ' + info.loginInfo.access_token,
              ...
              //         Lampa.Noty.show('哦，' + element.name + '  的磁力链接已成功添加到 PikPak。');
              //       }
              //     } catch (e) {
              ...
              //   Lampa.Controller.toggle('content');
              // }, function (response) {
              //   Lampa.Noty.show('哦，'+ JSON.parse(response.error).error_description +'，添加到 PikPak 失败。');
              //   Lampa.Modal.close();
              //   Lampa.Controller.toggle('content');
              //   //console.error(response.error);
              // });
              // network.silent('https://cors.eu.org/https://api-drive.mypikpak.com/drive/v1/files', function (json) {
              //   if (json.upload_type === "UPLOAD_TYPE_URL") {
              ...
              cordovaFetch('https://api-drive.mypikpak.com/drive/v1/files', {
                method: 'POST',
                headers: {
