...
Lampa.Lang.AddTranslation('zh',{
    ...
    settings_cub_sync_descr: '与 CUB 服务同步：书签同步，浏览历史记录、标签和时间码。网站：www.cub.watch',
    ...
    torrent_parser_torlook_fallback_search_notification: 'Jackett解析器不可用或连接设置为不正确。搜索 Torlook...',
    about_text: '该应用程序是完全免费的，并使用公共链接来获取有关视频、新版本、热门电影等的信息。所有可用信息仅用于教育目的，该应用程序不使用其自己的服务器来分发信息。',
    about_channel: '我们的频道',
    about_group: '群组',
    about_version: '版本',
    about_donate: '捐赠',
    ...
    okko_ru_tv: '俄罗斯人',
    empty_title: '空',
    empty_text: '没有找到您的过滤器，请优化您的过滤器。',
    empty_title_two: '这里是空的',
    empty_text_two: '列表当前空。',
    menu_main: '首页',
    menu_movies: '电影',
    menu_tv: '剧集',
    menu_catalog: '目录',
    ...
    plugins_online: '在线查看',
    plugins_check_fail: '无法测试插件的功能。但这并不代表插件不起作用。重新加载应用程序看看插件是否正在加载。',
    plugins_need_reload: '要应用插件，需要重启应用',
    plugins_install: '安装',
    plugins_install_ready: 'This plugin is already installed.',
    plugins_installed: '安装ations',
    plugins_load_from: '从CUB中加载',
    plugins_ok_for_check: '点击(OK)测试plugin',
    ...
    helper_torrents_view: '按住 (OK) 键可重置时间码并显示菜单',
    fav_sync_title: '书签同步',
    fav_sync_text: '您最喜欢的书签。连接同步并在任何设备上查看。<br><br>为此，在网站 www.cub.watch 上注册，创建个人资料并登录应用程序。',
    fav_sync_site: '网站',
    fav_remove_title: '从历史记录中删除',
    fav_remove_descr: '删除所选卡',
    ...
    keyboard_listen: '说，我在听...',
    keyboard_nomic: '没有麦克风访问权限',
    notice_new_quality: '新质量可用',
    notice_quality: '质量',
    notice_new_episode: '新系列',
    notice_none: '你还没有任何通知，在 <b>www.cub.watch</b> 注册以关注新剧集和发布。',
    ...
    network_parsererror: '请求的JSON解析失败。',
    ...
    notice_none_account: '您还没有任何通知，为该系列添加书签并等待新剧集的通知。',
    ...
    player_normalization_power_title: '归一化能力',
    ...
    extensions_from_connected: '连接的插件',
    title_choice_language: '选择一种语言',
    search_nofound: '根据您的请求没有找到任何内容。',
    ...
    settings_rest_tmdb_api_descr: '要获取数据',
    settings_rest_tmdb_image_descr: '要获取图片',
    title_subscribe: '订阅',
    ...
    account_create: '用CUB帐户发现更多机会。注册在<span class="account-modal__site">www.cub.watch</span> 并获得同步书签、时间码和其他 CUB 帐户功能的权限。',
