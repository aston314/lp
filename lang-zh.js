...
Lampa.Lang.AddTranslation('zh',{
    ...
    extensions_from_connected: '已连接的插件',
    title_choice_language: '选择一种语言',
    search_nofound: '根据您的请求未找到任何内容。',
    ...
    account_create: '使用CUB帐户发现更多机会。注册在<span class="account-modal__site">www.cub.watch</span> 并获得同步您的书签、时间码和其他 CUB 帐户功能的权限。',
