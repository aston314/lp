    ...
    function collection(object) {
        ...
        this.card = function (str) {
            ...
            str = str.replace(/\n/g, '');
                ...
                //console.log(h)
                total_pages = $(catalogs1[0].list.page.selector, str).find('a').length;
                var host = object.url.indexOf('http') == -1 ? '' : object.url.match(/(http|https):\/\/(www.)?(\w+(\.)?)+/)[0];
                //console.log($(catalogs1[0].list.page.selector, str).find('a').last().attr('href')) :last-child
                page = $(catalogs1[0].list.page.selector, str).find('a').last().attr('href').indexOf('http') == -1 ? host+$(catalogs1[0].list.page.selector, str).find('a').last().attr('href') : $(catalogs1[0].list.page.selector, str).find('a').last().attr('href');
                //console.log(page)
