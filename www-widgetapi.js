...
var Lc,Pc=Object.freeze(Fc([]));function Qc(a){if(G(a.u))throw Error("Cannot mutate an immutable Message");}
...
function dd(a,b,c,d){var e=cd(a,b,d);Array.isArray(e)?e&&Dc(e)&1||Fc(e):e=Pc;if(G(a.u))c&1||(Bc(e,2),Object.freeze(e));else if(e===Pc||G(e))e=Fc(Array.prototype.slice.call(e)),I(a,b,e,d);return e}
...
function jd(a,b,c,d){Qc(a);if(null!=d){var e=Fc([]);for(var f=!1,g=0;g<d.length;g++)e[g]=Uc(d[g],b).u,f=f||G(e[g]);a.i||(a.i={});a.i[c]=d;Ic(e,!f)}else a.i&&(a.i[c]=void 0),e=Pc;return I(a,c,e)}
...
if(c)for(e=0;e<c.length;e++)b=c[e],b<this.m?(b+=this.l,(d=this.u[b])?Array.isArray(d)&&Fc(d):this.u[b]=Pc):(d=bd(this),(f=d[b])?Array.isArray(f)&&Fc(f):d[b]=Pc)}
...
signal:f}),5);case 5:g=!0;case 3:Aa(h);a.A=void 0;a.m&&(a.K.Z(a.m),a.m=0);g!==a.j&&(a.j=g,a.j?He(a,"networkstatus-online"):He(a,"networkstatus-offline"));c(g);Ba(h);break;case 2:za(h),g=!1,h.v(3)}})})}
...
(q=vd.screen)?void 0:q.availWidth;var v;e.u_cd=null==(v=vd.screen)?void 0:v.colorDepth}catch(Y){}h=b.i;try{var p=h.screenX;var y=h.screenY}catch(Y){}try{var z=h.outerWidth;var H=h.outerHeight}catch(Y){}try{var K=h.innerWidth;var M=h.innerHeight}catch(Y){}try{var O=h.screenLeft;var ob=h.screenTop}catch(Y){}try{K=h.innerWidth,M=h.innerHeight}catch(Y){}try{var xc=h.screen.availWidth;var xa=h.screen.availTop}catch(Y){}p=[O,ob,p,y,xc,xa,z,H,K,M];y=b.i.top;try{var ra=(y||window).document,Z="CSS1Compat"==
ra.compatMode?ra.documentElement:ra.body;var da=(new Ad(Z.clientWidth,Z.clientHeight)).round()}catch(Y){da=new Ad(-12245933,-12245933)}ra=da;da={};var ea=void 0===ea?A:ea;Z=new Oe;ea.SVGElement&&ea.document.createElementNS&&Z.set(0);y=Hd();y["allow-top-navigation-by-user-activation"]&&Z.set(1);y["allow-popups-to-escape-sandbox"]&&Z.set(2);ea.crypto&&ea.crypto.subtle&&Z.set(3);ea.TextDecoder&&ea.TextEncoder&&Z.set(4);ea=Pe(Z);da.bc=ea;da.bih=ra.height;da.biw=ra.width;da.brdim=p.join();b=b.j;b=(da.vis=
...
function Lj(a,b,c,d){var e,f,g,h,k,l,m,q,v,p,y,z;return x(function(H){switch(H.i){case 1:var K={mode:"readonly",J:!1,tag:"IDB_TRANSACTION_TAG_UNKNOWN"};"string"===typeof c?K.mode=c:Object.assign(K,c);e=K;a.transactionCount++;f=e.J?3:1;g=0;case 2:if(h){H.v(3);break}g++;k=Math.round(T());wa(H,4);l=a.i.transaction(b,e.mode);K=new Pj(l);K=Qj(K,d);return w(H,K,6);case 6:return m=H.j,q=Math.round(T()),Rj(a,k,q,g,void 0,b.join(),e),H.return(m);case 4:v=za(H);p=Math.round(T());y=yj(v,a.i.name,b.join(),a.i.version);
if((z=y instanceof U&&!y.i)||g>=f)Rj(a,k,p,g,y,b.join(),e),h=y;H.v(2);break;case 3:return H.return(Promise.reject(h))}})}
function Rj(a,b,c,d,e,f,g){b=c-b;e?(e instanceof U&&("QUOTA_EXCEEDED"===e.type||"QUOTA_MAYBE_EXCEEDED"===e.type)&&jj("QUOTA_EXCEEDED",{dbName:oj(a.i.name),objectStoreNames:f,transactionCount:a.transactionCount,transactionMode:g.mode}),e instanceof U&&"UNKNOWN_ABORT"===e.type&&(c-=a.l,0>c&&c>=Math.pow(2,31)&&(c=0),jj("TRANSACTION_UNEXPECTEDLY_ABORTED",{objectStoreNames:f,transactionDuration:b,transactionCount:a.transactionCount,dbDuration:c}),a.j=!0),Gk(a,!1,d,f,b,g.tag),ij(e)):Gk(a,!0,d,f,b,g.tag)}
function Gk(a,b,c,d,e,f){jj("TRANSACTION_ENDED",{objectStoreNames:d,connectionHasUnknownAbortedTransaction:a.j,duration:e,isSuccessful:b,tryCount:c,tag:void 0===f?"IDB_TRANSACTION_TAG_UNKNOWN":f})}
...
if(2!=g.i)return ya(g,0);f=za(g);throw yj(f,a,"",-1);})}
...
case 6:throw new vj(m,l);case 5:return z.return(h);case 2:q=za(z);if(q instanceof DOMException?"VersionError"!==q.name:"DOMError"in self&&q instanceof DOMError?"VersionError"!==q.name:!(q instanceof Object&&"message"in q)||"An attempt was made to open a database using a lower version than the existing version."!==q.message){z.v(10);break}return w(z,a.l(a.name,void 0,Object.assign({},d,{upgrade:void 0})),11);case 11:v=z.j;p=v.i.version;if(void 0!==a.options.version&&p>a.options.version+1)throw v.close(),
...
wa(e,2);d={actualName:"yt-idb-test-do-not-use",publicName:"yt-idb-test-do-not-use",userIdentifier:void 0};return w(e,Wk(d,al),4);case 4:return w(e,Xk("yt-idb-test-do-not-use",al),5);case 5:return e.return(!0);case 2:return za(e),e.return(!1)}})}
...
function gl(a,b,c,d){var e,f,g,h,k,l;return x(function(m){switch(m.i){case 1:return f=null!=(e=Error().stack)?e:"",w(m,el(),2);case 2:g=m.j;if(!g)throw h=zj("openDbImpl",a,b),R("ytidb_async_stack_killswitch")||(h.stack=h.stack+"\n"+f.substring(f.indexOf("\n")+1)),ij(h),h;nj(a);k=c?{actualName:a,publicName:a,userIdentifier:void 0}:fl(a);wa(m,3);return w(m,Wk(k,g),5);case 5:return w(m,Ok(k.actualName,b,d),6);case 6:return m.return(m.j);case 3:return l=za(m),wa(m,7),w(m,Xk(k.actualName,g),9);case 9:ya(m,
...
Hm.prototype.storePayload=function(a,b){this.store.push({payload:b,keys:a});b=[void 0===a.auth?"undefined":a.auth,void 0===a.isJspb?"undefined":a.isJspb,void 0===a.cttAuthInfo?"undefined":a.cttAuthInfo].join("/");this.i[b]?this.i[b]++:this.i[b]=1;this.i[b]>=this.policy.maxBatchSize&&(this.policy.onBatchSizeExceeded(a),this.i[b]=0);return b};
Hm.prototype.extractMatchingEntries=function(a){for(var b=[],c=[],d=t(this.store),e=d.next();!e.done;e=d.next()){e=e.value;a:{var f=a;var g=Object.keys(f);g=t(g);for(var h=g.next();!h.done;h=g.next())if(h=h.value,e.keys[h]!==f[h]){f=!1;break a}f=!0}f?b.push(e.payload):c.push(e)}this.store=c;c=0;d=Im(this,a);a=[];d=t(d);for(e=d.next();!e.done;e=d.next())e=e.value,c+=this.i[e],a.push([e,this.i[e]]),this.i[e]=0;c!==b.length&&Mh(new kj("Transport IMS extracted entries count != keyCounter sum",a,b.length));
return b};
Hm.prototype.getSequenceCount=function(a){var b=Im(this,a);a=0;b=t(b);for(var c=b.next();!c.done;c=b.next())a+=this.i[c.value];return a};
function Im(a,b){var c=Object.keys(b),d="THIS_KEY_FIELD_NOT_FILLED",e="THIS_KEY_FIELD_NOT_FILLED",f="THIS_KEY_FIELD_NOT_FILLED";c=t(c);for(var g=c.next();!g.done;g=c.next())g=g.value,"auth"===g?d=Jm(b.auth):"isJspb"===g?e=JSON.stringify(b.isJspb):"cttAuthInfo"===g&&(f=Jm(b.cttAuthInfo));b=[];d=[d,e,f];a=t(Object.keys(a.i));for(e=a.next();!e.done;e=a.next()){e=e.value;f=e.split("/");c=!0;for(g=0;g<d.length;g++)if("THIS_KEY_FIELD_NOT_FILLED"!==d[g]&&d[g]!==f[g]){c=!1;break}c&&b.push(e)}return b}
Hm.prototype.getSequenceCount=Hm.prototype.getSequenceCount;Hm.prototype.extractMatchingEntries=Hm.prototype.extractMatchingEntries;Hm.prototype.storePayload=Hm.prototype.storePayload;function Jm(a){return void 0===a?"undefined":a}
;var Km=hi("initial_gel_batch_timeout",2E3),Lm=Math.pow(2,16)-1,Mm=void 0;function Nm(){this.l=this.i=this.j=0}
var Om=new Nm,Pm=new Nm,Qm=!0,Rm=A.ytLoggingTransportGELQueue_||new Map;B("ytLoggingTransportGELQueue_",Rm);var Sm=A.ytLoggingTransportGELProtoQueue_||new Map;B("ytLoggingTransportGELProtoQueue_",Sm);var Tm=A.ytLoggingTransportTokensToCttTargetIds_||{};B("ytLoggingTransportTokensToCttTargetIds_",Tm);var Um=A.ytLoggingTransportTokensToJspbCttTargetIds_||{};B("ytLoggingTransportTokensToJspbCttTargetIds_",Um);var Vm={};
function Wm(){var a=C("yt.logging.ims");a||(a=new Hm({maxBatchSize:hi("tvhtml5_logging_max_batch")||hi("web_logging_max_batch")||100,onBatchSizeExceeded:function(b){Xm({writeThenSend:!0},void 0,b.isJspb)}}),B("yt.logging.ims",a));
return a}
function Ym(a,b){if("log_event"===a.endpoint){Zm(a);var c=$m(a);if(R("use_new_in_memory_storage")){Vm[c]=!0;var d={cttAuthInfo:c,isJspb:!1};Wm().storePayload(d,a.payload);an(b,[],c,!1,d)}else d=Rm.get(c)||[],Rm.set(c,d),d.push(a.payload),an(b,d,c)}}
function bn(a,b){if("log_event"===a.endpoint){Zm(void 0,a);var c=$m(a,!0);if(R("use_new_in_memory_storage")){Vm[c]=!0;var d={cttAuthInfo:c,isJspb:!0};Wm().storePayload(d,a.payload.toJSON());an(b,[],c,!0,d)}else d=Sm.get(c)||[],Sm.set(c,d),a=a.payload.toJSON(),d.push(a),an(b,d,c,!0)}}
function an(a,b,c,d,e){d=void 0===d?!1:d;a&&(Mm=new a);a=hi("tvhtml5_logging_max_batch")||hi("web_logging_max_batch")||100;var f=T(),g=d?Pm.l:Om.l;b=b.length;e&&(b=Wm().getSequenceCount(e));b>=a?Xm({writeThenSend:!0},R("flush_only_full_queue")?c:void 0,d):10<=f-g&&(cn(d),d?Pm.l=f:Om.l=f)}
function dn(a,b){if("log_event"===a.endpoint){Zm(a);var c=$m(a),d=new Map;d.set(c,[a.payload]);b&&(Mm=new b);return new Of(function(e,f){Mm&&Mm.isReady()?en(d,Mm,e,f,{bypassNetworkless:!0},!0):e()})}}
function fn(a,b){if("log_event"===a.endpoint){Zm(void 0,a);var c=$m(a,!0),d=new Map;d.set(c,[a.payload.toJSON()]);b&&(Mm=new b);return new Of(function(e){Mm&&Mm.isReady()?gn(d,Mm,e,{bypassNetworkless:!0},!0):e()})}}
function $m(a,b){var c="";if(a.ea)c="visitorOnlyApprovedKey";else if(a.cttAuthInfo){if(void 0===b?0:b){b=a.cttAuthInfo.token;c=a.cttAuthInfo;var d=new xh;c.videoId?d.setVideoId(c.videoId):c.playlistId&&ed(d,2,yh,c.playlistId);Um[b]=d}else b=a.cttAuthInfo,c={},b.videoId?c.videoId=b.videoId:b.playlistId&&(c.playlistId=b.playlistId),Tm[a.cttAuthInfo.token]=c;c=a.cttAuthInfo.token}return c}
function Xm(a,b,c){a=void 0===a?{}:a;c=void 0===c?!1:c;new Of(function(d,e){c?(window.clearTimeout(Pm.j),window.clearTimeout(Pm.i),Pm.i=0):(window.clearTimeout(Om.j),window.clearTimeout(Om.i),Om.i=0);if(Mm&&Mm.isReady())if(R("use_new_in_memory_storage")){var f=a,g=c,h=Mm;f=void 0===f?{}:f;g=void 0===g?!1:g;var k=new Map,l=new Map;if(void 0!==b)g?(e=Wm().extractMatchingEntries({isJspb:g,cttAuthInfo:b}),k.set(b,e),gn(k,h,d,f)):(k=Wm().extractMatchingEntries({isJspb:g,cttAuthInfo:b}),l.set(b,k),en(l,
h,d,e,f));else if(g){e=t(Object.keys(Vm));for(g=e.next();!g.done;g=e.next())l=g.value,g=Wm().extractMatchingEntries({isJspb:!0,cttAuthInfo:l}),0<g.length&&k.set(l,g),delete Vm[l];gn(k,h,d,f)}else{k=t(Object.keys(Vm));for(g=k.next();!g.done;g=k.next()){g=g.value;var m=Wm().extractMatchingEntries({isJspb:!1,cttAuthInfo:g});0<m.length&&l.set(g,m);delete Vm[g]}en(l,h,d,e,f)}}else f=a,k=c,h=Mm,f=void 0===f?{}:f,k=void 0===k?!1:k,void 0!==b?k?(e=new Map,k=Sm.get(b)||[],e.set(b,k),gn(e,h,d,f),Sm.delete(b)):
(k=new Map,l=Rm.get(b)||[],k.set(b,l),en(k,h,d,e,f),Rm.delete(b)):k?(gn(Sm,h,d,f),Sm.clear()):(en(Rm,h,d,e,f),Rm.clear());else cn(c),d()})}
function cn(a){a=void 0===a?!1:a;if(R("web_gel_timeout_cap")&&(!a&&!Om.i||a&&!Pm.i)){var b=Wh(function(){Xm({writeThenSend:!0},void 0,a)},6E4);
a?Pm.i=b:Om.i=b}window.clearTimeout(a?Pm.j:Om.j);b=P("LOGGING_BATCH_TIMEOUT",hi("web_gel_debounce_ms",1E4));R("shorten_initial_gel_batch_timeout")&&Qm&&(b=Km);b=Wh(function(){Xm({writeThenSend:!0},void 0,a)},b);
a?Pm.j=b:Om.j=b}
function en(a,b,c,d,e,f){e=void 0===e?{}:e;var g=Math.round(T()),h=a.size;a=t(a);for(var k=a.next();!k.done;k=a.next()){var l=t(k.value);k=l.next().value;var m=l.next().value;l=k;k=mb({context:Ji(b.config_||Ii())});if(!Ma(m)&&!R("throw_err_when_logevent_malformed_killswitch")){d();break}k.events=m;(m=Tm[l])&&hn(k,l,m);delete Tm[l];l="visitorOnlyApprovedKey"===l;jn(k,g,l);kn(e);m=function(){h--;h||c()};
var q=function(){h--;h||c()};
try{Yi(b,"log_event",k,ln(e,l,m,q,f)),Qm=!1}catch(v){Lh(v),d()}}}
function gn(a,b,c,d,e){d=void 0===d?{}:d;var f=Math.round(T()),g=a.size,h=new Map([].concat(ia(a)));h=t(h);for(var k=h.next();!k.done;k=h.next()){var l=t(k.value).next().value,m=a.get(l);k=new zh;var q=Oi(b.config_||Ii());J(k,eh,1,q);m=m?mn(m):[];m=t(m);for(q=m.next();!q.done;q=m.next())kd(k,3,uh,q.value);(m=Um[l])&&nn(k,l,m);delete Um[l];l="visitorOnlyApprovedKey"===l;on(k,f,l);kn(d);k=od(k);l=ln(d,l,function(){g--;g||c()},function(){g--;
g||c()},e);
l.headers["Content-Type"]="application/json+protobuf";l.postBodyFormat="JSPB";l.postBody=k;Yi(b,"log_event","",l);Qm=!1}}
function kn(a){R("always_send_and_write")&&(a.writeThenSend=!1)}
function ln(a,b,c,d,e){a={retry:!0,onSuccess:c,onError:d,Ua:a,ea:b,Rb:!!e,headers:{},postBodyFormat:"",postBody:""};R("use_request_time_ms_header")&&(a.headers["X-Goog-Request-Time"]=JSON.stringify(Math.round(T())));return a}
function jn(a,b,c){R("use_request_time_ms_header")||(a.requestTimeMs=String(b));R("unsplit_gel_payloads_in_logs")&&(a.unsplitGelPayloadsInLogs=!0);!c&&(b=P("EVENT_ID"))&&(c=pn(),a.serializedClientEventId={serializedEventId:b,clientCounter:String(c)})}
function on(a,b,c){R("use_request_time_ms_header")||I(a,2,b);if(!c&&(b=P("EVENT_ID"))){c=pn();var d=new wh;I(d,1,b);I(d,2,c);J(a,wh,5,d)}}
function pn(){var a=P("BATCH_CLIENT_COUNTER")||0;a||(a=Math.floor(Math.random()*Lm/2));a++;a>Lm&&(a=1);Fh("BATCH_CLIENT_COUNTER",a);return a}
function hn(a,b,c){if(c.videoId)var d="VIDEO";else if(c.playlistId)d="PLAYLIST";else return;a.credentialTransferTokenTargetId=c;a.context=a.context||{};a.context.user=a.context.user||{};a.context.user.credentialTransferTokens=[{token:b,scope:d}]}
function nn(a,b,c){if(cd(c,1===fd(c,yh)?1:-1))var d=1;else if(c.getPlaylistId())d=2;else return;J(a,xh,4,c);a=gd(a,eh,1)||new eh;c=gd(a,ch,3)||new ch;var e=new bh;e.setToken(b);I(e,1,d);kd(c,12,bh,e);J(a,ch,3,c)}
function mn(a){for(var b=[],c=0;c<a.length;c++)try{b.push(new uh(a[c]))}catch(d){Lh(new kj("Transport failed to deserialize "+String(a[c])))}return b}
function Zm(a,b){if(C("yt.logging.transport.enableScrapingForTest")){var c=C("yt.logging.transport.scrapedPayloadsForTesting"),d=C("yt.logging.transport.payloadToScrape","");b&&(b=C("yt.logging.transport.getScrapedPayloadFromClientEventsFunction").bind(b.payload)())&&c.push(b);a&&a.payload[d]&&c.push((null==a?void 0:a.payload)[d]);B("yt.logging.transport.scrapedPayloadsForTesting",c)}}
;var qn=A.ytLoggingGelSequenceIdObj_||{};B("ytLoggingGelSequenceIdObj_",qn);
function rn(a,b,c,d){d=void 0===d?{}:d;var e={},f=Math.round(d.timestamp||T());e.eventTimeMs=f<Number.MAX_SAFE_INTEGER?f:0;e[a]=b;R("enable_unknown_lact_fix_on_html5")&&zm();a=Cm();e.context={lastActivityMs:String(d.timestamp||!isFinite(a)?-1:a)};R("log_sequence_info_on_gel_web")&&d.ja&&(a=e.context,b=d.ja,b={index:sn(b),groupKey:b},a.sequence=b,d.lb&&delete qn[d.ja]);(d.vb?dn:Ym)({endpoint:"log_event",payload:e,cttAuthInfo:d.cttAuthInfo,ea:d.ea},c)}
function tn(a){Xm(void 0,void 0,void 0===a?!1:a)}
function sn(a){qn[a]=a in qn?qn[a]+1:0;return qn[a]}
;var un=A.ytLoggingGelSequenceIdObj_||{};B("ytLoggingGelSequenceIdObj_",un);function vn(a){var b=void 0;b=void 0===b?{}:b;var c=!1;P("ytLoggingEventsDefaultDisabled",!1)&&(c=!0);c=c?null:vm;b=void 0===b?{}:b;var d=Math.round(b.timestamp||T());I(a,1,d<Number.MAX_SAFE_INTEGER?d:0);var e=Cm();d=new th;I(d,1,b.timestamp||!isFinite(e)?-1:e);if(R("log_sequence_info_on_gel_web")&&b.ja){e=b.ja;var f=sn(e),g=new sh;I(g,2,f);I(g,1,e);J(d,sh,3,g);b.lb&&delete un[b.ja]}J(a,th,33,d);(b.vb?fn:bn)({endpoint:"log_event",payload:a,cttAuthInfo:b.cttAuthInfo,ea:b.ea},c)}
;function wn(a,b){var c=void 0===c?{}:c;if(R("migrate_events_to_ts")){c=void 0===c?{}:c;var d=vm;P("ytLoggingEventsDefaultDisabled",!1)&&vm===vm&&(d=null);rn(a,b,d,c)}else d=vm,P("ytLoggingEventsDefaultDisabled",!1)&&vm==vm&&(d=null),rn(a,b,d,c)}
;var xn=[{Da:function(a){return"Cannot read property '"+a.key+"'"},
...
sa:{ReferenceError:[{regexp:/(.*) is not defined/,groups:["key"]},{regexp:/Can't find variable: (.*)/,groups:["key"]}]}}];var zn={V:[],T:[{fb:yn,weight:500}]};function yn(a){if("JavaException"===a.name)return!0;a=a.stack;return a.includes("chrome://")||a.includes("chrome-extension://")||a.includes("moz-extension://")}
;function An(){this.T=[];this.V=[]}
var Bn;function Cn(){if(!Bn){var a=Bn=new An;a.V.length=0;a.T.length=0;zn.V&&a.V.push.apply(a.V,zn.V);zn.T&&a.T.push.apply(a.T,zn.T)}return Bn}
;var Dn=new N;function En(a){function b(){return a.charCodeAt(d++)}
...
;function Qn(){var a;return x(function(b){return(a=ff())?b.return(a.then(function(c){c=od(c);for(var d=[],e=0,f=0;f<c.length;f++){var g=c.charCodeAt(f);255<g&&(d[e++]=g&255,g>>=8);d[e++]=g}return uc(d,3)})):b.return(Promise.resolve(null))})}
;var Rn={};function Sn(a){return Rn[a]||(Rn[a]=String(a).replace(/\-([a-z])/g,function(b,c){return c.toUpperCase()}))}
;var Tn={},Un=[],Bg=new N,Vn={};function Wn(){for(var a=t(Un),b=a.next();!b.done;b=a.next())b=b.value,b()}
...
function Yn(a){Bg.da.apply(Bg,arguments)}
...
function ao(a,b,c){bo||(bo={},Vh(window,"message",function(d){a:{if(d.origin===$n(a,"host")){try{var e=JSON.parse(d.data)}catch(f){e=void 0;break a}if(d=bo[e.id])d.A=!0,d.A&&(E(d.o,d.sendMessage,d),d.o.length=0),d.Ka(e)}e=void 0}return e}));
bo[c]=b}
var bo=null;var co=window;function eo(a,b,c){this.s=this.i=this.j=null;this.l=0;this.A=!1;this.o=[];this.m=null;this.I={};if(!a)throw Error("YouTube player element ID required.");this.id=Qa(this);this.D=c;this.setup(a,b)}
...
n.Ka=function(a){fo(this,a.event,a)};
...
n.destroy=function(){this.i&&this.i.id&&(Tn[this.i.id]=null);var a=this.m;a&&"function"==typeof a.dispose&&a.dispose();if(this.s){a=this.i;var b=a.parentNode;b&&b.replaceChild(this.s,a)}else(a=this.i)&&a.parentNode&&a.parentNode.removeChild(a);bo&&(bo[this.id]=null);this.j=null;a=this.i;for(var c in kb)kb[c][0]==a&&Th(c);this.s=this.i=null};
...
function fo(a,b,c){a.m.l||(c={target:a,data:c},a.m.da(b,c),Yn(a.D+"."+b,c))}
...
co.yt_embedsTokenValue&&(g.embedsTokenValue=encodeURIComponent(co.yt_embedsTokenValue),delete co.yt_embedsTokenValue);var h=""+$n(a.j,"host")+("/embed/"+$n(a.j,"videoId"))+"?"+Tb(g);co.yt_embedsEnableUaChProbe?Qn().then(function(k){var l=new URL(h),m=Number(l.searchParams.get("reloads"));isNaN(m)&&(m=0);l.searchParams.set("reloads",(m+1).toString());k&&l.searchParams.set("uach",k);l.searchParams.set("uats",Math.floor(window.performance.timeOrigin).toString());k=Md(l.href).toString();yd(c,Nd(k));return k}):
co.yt_embedsEnableIframeSrcWithIntent?yd(c,Nd(h)):c.src=h;
return c}
n.Va=function(){this.i&&this.i.contentWindow?this.sendMessage({event:"listening"}):window.clearInterval(this.l)};
function ko(a){ao(a.j,a,a.id);a.l=Xh(a.Va.bind(a),250);Vh(a.i,"load",function(){window.clearInterval(a.l);a.l=Xh(a.Va.bind(a),250)})}
n.setup=function(a,b){var c=document;if(a="string"===typeof a?c.getElementById(a):a)if(c="iframe"===a.tagName.toLowerCase(),b.host||(b.host=c?Rb(a.src):"https://www.youtube.com"),this.j=new Zn(b),c||(b=jo(this,a),this.s=a,(c=a.parentNode)&&c.replaceChild(b,a),a=b),this.i=a,this.i.id||(this.i.id="widget"+Qa(this.i)),Tn[this.i.id]=this,window.postMessage){this.m=new N;ko(this);b=$n(this.j,"events");for(var d in b)b.hasOwnProperty(d)&&this.addEventListener(d,b[d]);for(var e in Vn)Vn.hasOwnProperty(e)&&
ho(this,e)}};
function go(a,b){a.I[b]||(a.I[b]=!0,io(a,"addEventListener",[b]))}
...
h;if(f){f.hasOwnProperty("level")&&f.level&&(h=f.level);if(R("console_log_js_exceptions")){var k=f,l=[];l.push("Name: "+k.name);l.push("Message: "+k.message);k.hasOwnProperty("params")&&l.push("Error Params: "+JSON.stringify(k.params));k.hasOwnProperty("args")&&l.push("Error args: "+JSON.stringify(k.args));l.push("File name: "+k.fileName);l.push("Stacktrace: "+k.stack);window.console.log(l.join("\n"),k)}if(!(5<=Kn)){var m=void 0,q=void 0,v=f,p=g,y=ee(v),z=y.message||"Unknown Error",H=y.name||"UnknownError",
K=y.stack||v.j||"Not available";if(K.startsWith(H+": "+z)){var M=K.split("\n");M.shift();K=M.join("\n")}var O=y.lineNumber||"Not available",ob=y.fileName||"Not available",xc=K,xa=0;if(v.hasOwnProperty("args")&&v.args&&v.args.length)for(var ra=0;ra<v.args.length&&!(xa=Gn(v.args[ra],"params."+ra,p,xa),500<=xa);ra++);else if(v.hasOwnProperty("params")&&v.params){var Z=v.params;if("object"===typeof v.params)for(q in Z){if(Z[q]){var da="params."+q,ea=In(Z[q]);p[da]=ea;xa+=da.length+ea.length;if(500<xa)break}}else p.params=
In(Z)}if(Nn.length)for(var Y=0;Y<Nn.length&&!(xa=Gn(Nn[Y],"params.context."+Y,p,xa),500<=xa);Y++);navigator.vendor&&!p.hasOwnProperty("vendor")&&(p["device.vendor"]=navigator.vendor);var S={message:z,name:H,lineNumber:O,fileName:ob,stack:xc,params:p,sampleWeight:1},Sj=Number(v.columnNumber);isNaN(Sj)||(S.lineNumber=S.lineNumber+":"+Sj);if("IGNORED"===v.level)m=0;else a:{for(var Tj=Cn(),Uj=t(Tj.V),Sf=Uj.next();!Sf.done;Sf=Uj.next()){var Vj=Sf.value;if(S.message&&S.message.match(Vj.Sb)){m=Vj.weight;
break a}}for(var Wj=t(Tj.T),Tf=Wj.next();!Tf.done;Tf=Wj.next()){var Xj=Tf.value;if(Xj.fb(S)){m=Xj.weight;break a}}m=1}S.sampleWeight=m;for(var Yj=t(xn),Uf=Yj.next();!Uf.done;Uf=Yj.next()){var Vf=Uf.value;if(Vf.sa[S.name])for(var Zj=t(Vf.sa[S.name]),Wf=Zj.next();!Wf.done;Wf=Zj.next()){var ak=Wf.value,Wd=S.message.match(ak.regexp);if(Wd){S.params["params.error.original"]=Wd[0];for(var Xf=ak.groups,bk={},$b=0;$b<Xf.length;$b++)bk[Xf[$b]]=Wd[$b+1],S.params["params.error."+Xf[$b]]=Wd[$b+1];S.message=Vf.Da(bk);
break}}}S.params||(S.params={});var ck=Cn();S.params["params.errorServiceSignature"]="msg="+ck.V.length+"&cb="+ck.T.length;S.params["params.serviceWorker"]="false";A.document&&A.document.querySelectorAll&&(S.params["params.fscripts"]=String(document.querySelectorAll("script:not([nonce])").length));sb("sample").constructor!==rb&&(S.params["params.fconst"]="true");var ta=S;window.yterr&&"function"===typeof window.yterr&&window.yterr(ta);if(0!==ta.sampleWeight&&!Jn.has(ta.message)){if("ERROR"===h){Dn.da("handleError",
ta);if(R("record_app_crashed_web")&&0===Mn&&1===ta.sampleWeight)if(Mn++,R("errors_via_jspb")){var Yf=new rh;I(Yf,1,1);if(!R("report_client_error_with_app_crash_ks")){var dk=new mh;I(dk,1,ta.message);var ek=new nh;J(ek,mh,3,dk);var fk=new oh;J(fk,nh,5,ek);var gk=new ph;J(gk,oh,9,fk);J(Yf,ph,4,gk)}var qo=Yf,hk=new uh;id(hk,rh,20,vh,qo);vn(hk)}else{var ik={appCrashType:"APP_CRASH_TYPE_BREAKPAD"};R("report_client_error_with_app_crash_ks")||(ik.systemHealth={crashData:{clientError:{logMessage:{message:ta.message}}}});
wn("appCrashed",ik)}Ln++}else"WARNING"===h&&Dn.da("handleWarning",ta);if(R("kevlar_gel_error_routing"))a:{var Zf=void 0,$f=void 0,Mc=h,Q=ta;if(R("errors_via_jspb")){if(Pn())$f=void 0;else{var ac=new jh;I(ac,1,Q.stack);Q.fileName&&I(ac,4,Q.fileName);var Oa=Q.lineNumber&&Q.lineNumber.split?Q.lineNumber.split(":"):[];0!==Oa.length&&(1!==Oa.length||isNaN(Number(Oa[0]))?2!==Oa.length||isNaN(Number(Oa[0]))||isNaN(Number(Oa[1]))||(I(ac,2,Number(Oa[0])),I(ac,3,Number(Oa[1]))):I(ac,2,Number(Oa[0])));var vb=
new mh;I(vb,1,Q.message);I(vb,3,Q.name);I(vb,6,Q.sampleWeight);"ERROR"===Mc?I(vb,2,2):"WARNING"===Mc?I(vb,2,1):I(vb,2,0);var ag=new kh;I(ag,1,!0);id(ag,jh,3,lh,ac);var wb=new gh;I(wb,3,window.location.href);for(var jk=P("FEXP_EXPERIMENTS",[]),bg=0;bg<jk.length;bg++){var kk=wb,ro=jk[bg];Qc(kk);dd(kk,5,2,!1).push(ro)}var cg=Gh();if(!Hh()&&cg)for(var lk=t(Object.keys(cg)),xb=lk.next();!xb.done;xb=lk.next()){var mk=xb.value,dg=new ih;I(dg,1,mk);dg.setValue(String(cg[mk]));kd(wb,4,ih,dg)}var eg=Q.params;
if(eg){var nk=t(Object.keys(eg));for(xb=nk.next();!xb.done;xb=nk.next()){var ok=xb.value,fg=new ih;I(fg,1,"client."+ok);fg.setValue(String(eg[ok]));kd(wb,4,ih,fg)}}var pk=P("SERVER_NAME"),qk=P("SERVER_VERSION");if(pk&&qk){var gg=new ih;I(gg,1,"server.name");gg.setValue(pk);kd(wb,4,ih,gg);var hg=new ih;I(hg,1,"server.version");hg.setValue(qk);kd(wb,4,ih,hg)}var Xd=new nh;J(Xd,gh,1,wb);J(Xd,kh,2,ag);J(Xd,mh,3,vb);$f=Xd}var rk=$f;if(!rk)break a;var sk=new uh;id(sk,nh,163,vh,rk);vn(sk)}else{if(Pn())Zf=
...
Mc&&(ig.level="ERROR_LEVEL_WARNNING");var so={isObfuscated:!0,browserStackInfo:Nc},bc={pageUrl:window.location.href,kvPairs:[]};P("FEXP_EXPERIMENTS")&&(bc.experimentIds=P("FEXP_EXPERIMENTS"));var jg=Gh();if(!Hh()&&jg)for(var tk=t(Object.keys(jg)),yb=tk.next();!yb.done;yb=tk.next()){var uk=yb.value;bc.kvPairs.push({key:uk,value:String(jg[uk])})}var kg=Q.params;if(kg){var vk=t(Object.keys(kg));for(yb=vk.next();!yb.done;yb=vk.next()){var wk=yb.value;bc.kvPairs.push({key:"client."+wk,value:String(kg[wk])})}}var xk=
P("SERVER_NAME"),yk=P("SERVER_VERSION");xk&&yk&&(bc.kvPairs.push({key:"server.name",value:xk}),bc.kvPairs.push({key:"server.version",value:yk}));Zf={errorMetadata:bc,stackTrace:so,logMessage:ig}}var zk=Zf;if(!zk)break a;wn("clientError",zk)}if("ERROR"===Mc||R("errors_flush_gel_always_killswitch"))b:if(R("migrate_events_to_ts"))c:{if(R("web_fp_via_jspb")&&(tn(!0),!R("web_fp_via_jspb_and_json")))break c;tn()}else{if(R("web_fp_via_jspb")&&(tn(!0),!R("web_fp_via_jspb_and_json")))break b;tn()}}if(!R("suppress_error_204_logging")){var zb=
ta,Oc=zb.params||{},ab={urlParams:{a:"logerror",t:"jserror",type:zb.name,msg:zb.message.substr(0,250),line:zb.lineNumber,level:h,"client.name":Oc.name},postParams:{url:P("PAGE_NAME",window.location.href),file:zb.fileName},method:"POST"};Oc.version&&(ab["client.version"]=Oc.version);if(ab.postParams){zb.stack&&(ab.postParams.stack=zb.stack);for(var Ak=t(Object.keys(Oc)),lg=Ak.next();!lg.done;lg=Ak.next()){var Bk=lg.value;ab.postParams["client."+Bk]=Oc[Bk]}var mg=Gh();if(mg)for(var Ck=t(Object.keys(mg)),
ng=Ck.next();!ng.done;ng=Ck.next()){var Dk=ng.value;ab.postParams[Dk]=mg[Dk]}var Ek=P("SERVER_NAME"),Fk=P("SERVER_VERSION");Ek&&Fk&&(ab.postParams["server.name"]=Ek,ab.postParams["server.version"]=Fk)}si(P("ECATCHER_REPORT_HOST","")+"/error_204",ab)}try{Jn.add(ta.message)}catch(xo){}Kn++}}}}}else throw Zb;}else console&&console.warn&&console.warn("The YouTube player is not attached to the DOM. API calls should be made after the onReady event. See more: https://developers.google.com/youtube/iframe_api_reference#Events")};function lo(a){return(0===a.search("cue")||0===a.search("load"))&&"loadModule"!==a}
...
u(no,eo);n=no.prototype;n.Na=function(){var a=$n(this.j,"playerVars");if(a){var b={},c;for(c in a)b[c]=a[c];a=b}else a={};window!==window.top&&document.referrer&&(a.widget_referrer=document.referrer.substring(0,256));if(c=$n(this.j,"embedConfig")){if(Na(c))try{c=JSON.stringify(c)}catch(d){console.error("Invalid embed config JSON",d)}a.embed_config=c}return a};
n.Ka=function(a){var b=a.event;a=a.info;switch(b){case "apiInfoDelivery":if(Na(a))for(var c in a)a.hasOwnProperty(c)&&(this.O[c]=a[c]);break;case "infoDelivery":oo(this,a);break;case "initialDelivery":Na(a)&&(window.clearInterval(this.l),this.playerInfo={},this.O={},po(this,a.apiInterface),oo(this,a));break;default:fo(this,b,a)}};
...
this.O={};io(this,c,arguments);return this}:mo(c)?this[c]=function(){var d=0;
...
B("YT.scan",Wn);B("YT.subscribe",function(a,b,c){Bg.subscribe(a,b,c);Vn[a]=!0;for(var d in Tn)Tn.hasOwnProperty(d)&&ho(Tn[d],a)});
