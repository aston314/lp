(function () {
    ...
    function component(object) {
      ...
      this.create = function () {
        ...
        var getlink = _this.getFilteredElement(jsonresult,"link","aliyundrive");
        //console.log(getlink.length);
        if (getlink.length>0){
...
/*        if (object.movie.number_of_seasons) {
      ...
      this.append = function (items) {
        ...
        items.forEach(function (element) {
          ...
          var item = Lampa.Template.get('yunpan', element);
...
/*            console.log("这里");
    ...
    if (!window.plugin_yunpan_ready) startPlugin();
