(function () {
  ...
  function component(object) {
    ...
    function PikPakProxy() {
      var url ;
      Lampa.Storage.get('pikpak_proxy') ? url = 'https://api-pikpak.tjsky.cf/': url = '';
      return url;
    }
})();
