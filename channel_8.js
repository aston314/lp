(function () {
    ...
    function TG(object) {
        ...
        var waitload;
        var doubanitem = [];
        var cors = 'https://proxy.cub.watch/cdn/';
        ...
        this.card = function (str) {
            ...
            str = str.replace(/\n/g, '');
                ...
                page = $('.tme_messages_more', str).attr('href').match(/[0-9]+(?=[^0-9]*$)(.*)/);
                ...
                $('div.tgme_widget_message_wrap.js-widget_message_wrap',str).each(function (i, html) {  
                    ...
                    card.push({
                        ...
                        title: $('.tgme_widget_message_text.js-message_text', html).html().match(/(.+?)<br>/)[1].replace(/(<([^>]+)>)/ig, '').replace(/中文片名：|资源标题：|资源名称：|名称：/,''),
                        original_title: '',
                        title_org: '',
