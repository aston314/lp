...
(function () {
    ...
    function component(object) {
      ...
      var filter_sources = ['找资源', '小纸条', '猫狸盘搜', '易搜', '霸王龙字幕组', '无名资源', '酷云',  'videocdn', 'rezka', 'kinobase', 'collaps', 'cdnmovies', 'filmix', 'hdvb', 'videoapi']; // шаловливые ручки
