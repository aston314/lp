		...
		this.append = function(data) {
			...
			data.forEach(function(element) {
				...
				card.on('hover:enter click', function() {
					$(this).addClass('focus');
					$('.info__title-original').text('🎧 '+name_song);
