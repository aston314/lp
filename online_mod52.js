                                    ...
                                    if (!doreg.use_referer) {
                                      ...
                                      network.silent(MacPlayer_, function (str) {
                                        ...
                                        $.getMultiScripts(aa, '').done(function () {
                                          ...
                                          if (setting_js) {
                                            var s_js = getRemote(MacPlayer_.split(url1_[0])[0] + '/' + url1_[1] + '/js/setting.js');
                                            //console.log(s_js)
                                            ...
                                            var d_sj = MacPlayer_.split(url1_[0])[0] + '/' + url1_[1] + '/' + c_js;
                                              ...
                                              try {
                                                ...
                                                console.log(url1_)
                                                  ...
                                                  $.getMultiScripts(aa, '').done(function () {
                                                    ...
                                                    //console.log(config.token);
                                                    console.log(MacPlayer_.replace('/' + doreg.link_folder + '/','').split(url1_[0])[0] + '/' + url1_[1] + '/js/setting.js')
                                                    if (setting_js) {
