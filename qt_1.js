(function () {
    ...
    function qingtingfm(object) {
      ...
      this.create = function () {
        var postdata;
        if (object.keyword){
            postdata = { "query": "{\n        searchResultsPage(keyword:\""+ object.keyword +"\", page:1, include:\"all\" ) {\n          tdk,\n          searchData,\n          numFound\n        }\n      }"};
        } else {
      ...
      this.next = function () {
        var postdata;
        if (object.keyword){
            postdata = postdata = { "query": "{\n        searchResultsPage(keyword:\""+ object.keyword +"\", page:"+ (parseInt(object.page++)+1) +", include:\"all\" ) {\n          tdk,\n          searchData,\n          numFound\n        }\n      }"};;
        } else {
...
//           });
    ...
    function startqingtingfm() {
      ...
      function addSettingsXztiao() {
        ...
        var menu_item = $('<li class="menu__item selector focus" data-action="yyds"><div class="menu__ico">' + ico + '</div><div class="menu__text">蜻蜓</div></li>');
