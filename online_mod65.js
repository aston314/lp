...
(function () {
    ...
    function web(component, _object, rule) {
      ...
      this.search = function (_object, kinopoisk_id) {
        ...
        select_title = object.movie.title;
        doreg = rule;
        var url1 = doreg.search_url.replace('#msearchword',encodeURIComponent(object.movie.title));
    ...
    function component(object) {
      ...
      var filter_sources = ['酷云', '阿里云盘', '小纸条', 'videocdn', 'rezka', 'kinobase', 'collaps', 'cdnmovies', 'filmix', 'hdvb', 'videoapi']; // шаловливые ручки
