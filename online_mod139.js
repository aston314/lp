...
(function () {
    ...
    function kunyu77(component, _object, rule) {
      ...
      this.search = function (_object, kinopoisk_id) {
        ...
        var url;
        kinopoisk_id === parseInt(kinopoisk_id, 10) ? url = cors_https + 'http://api.kunyu77.com/api.php/provide/videoPlaylist?ids=' + kinopoisk_id + '&version=2.0.4&sj=' + sj : url = cors_https + 'http://api.kunyu77.com/api.php/provide/searchVideo?searchName=' + encodeURIComponent(object.movie.title);
                  ...
                  if (json) {
                      ...
                      if (json.data.length !== 0) {
                          ...
                          if (json.data.length == 1) {
                              ...
                              url = cors_https + 'http://api.kunyu77.com/api.php/provide/videoPlaylist?ids=' + id + '&version=2.0.4&sj=' + sj;
                              // network.silent(url, function (json) {
                              //     if (json) {
                              //         if (json.data.episodes.length == 0) {
                              //             component.emptyForQuery(select_title)
