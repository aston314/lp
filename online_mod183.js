...
(function () {
    ...
    function zyk1080json(component, _object, rule) {
      var network = new Lampa.Reguest();
      var extract = {};
      var object = _object;
      var select_title = '';
      ...
      this.search = function (_object, kinopoisk_id) {
        ...
        //console.log(select_title.replace(/第(.+)季/, '').trim());
        var url,apiurl;
        apiurl = 'https://api.1080zyku.com';
        parseFloat(kinopoisk_id) ? url = apiurl + '/inc/apijson.php?ac=detail&ids=' + kinopoisk_id : url =  apiurl + '/inc/apijson.php?ac=search&wd=' + encodeURIComponent(object.movie.title);
                ...
                if (json.code != 0) {
                      ...
                      if (json.list.length !== 0) {
                          ...
                          if (json.list.length == 1) {
                              ...
                              url = apiurl + '/inc/apijson.php?ac=detail&ids=' + id ;
                              network.silent(url, function (json) {
                                  if (json) {
                                      if (json.list.length == 0) {
                                          component.emptyForQuery(select_title)
    ...
    function component(object) {
      ...
      var sources = {
        ...
        采集网1080: new zyk1080json(this, object),
