            ...
            items.forEach(function (element) {
                ...
                item.on('hover:focus', function (e) {
                    ...
                    if (file.indexOf('http') == -1) {
                        ...
                        if (filejs == 'wanmeikk.js') {
                            network.silent(math_parse_url + '?url=' + filecode + '&next=&id=0&nid=1', function (str) {
                                var parse_url = "urls = '(.+?)'"
                                ...
                                _this4.empty(network.errorDecode(a, c));
                            }, false, {
                                dataType: 'text'
                            });
                        }
                        // }else if (filejs == 'duoduozy.js') {
                        ...
                        // } 
                            ...
                            function fn1() {
                                return new Promise(function (resolve, reject) {
                                    const options = {
                                        method: 'get',
                                        headers: { Referer: doreg.referer}
                                      };
                                    cordova.plugin.http.sendRequest(math_parse_url + '?url=' + filecode + '&next=&id=0&nid=1', options, function (response) {
                                        // comment this line
                                        // callback(response);
                                    ...
                                    cordovaFetch(math_parse_url + '?url=' + filecode + '&next=&id=0&nid=1', {
                                        method : 'GET',
                                        headers: {
                                    ...
                                    .then(function(response) {
                                        ...
                                        try {
                                            ...
                                            var parse_url = "urls = '(.+?)'"
                                            var mathurl = new RegExp(parse_url, 'g').exec(body);
                                            var file = mathurl ? mathurl[1] : ''
                                            //console.log(file);
                                            if (file) {
                                                _this4.start();
