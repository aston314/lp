...
(function () {
    ...
    function zyk1080(component, _object, rule) {
      var network = new Lampa.Reguest();
      var extract = {};
      var object = _object;
      var select_title = '';
    ...
    function component(object) {
      ...
      var sources = {
        ...
        采集网1080: new zyk1080(this, object),
      ...
      var filter_sources = ['找资源', '小纸条', '猫狸盘搜', '易搜', '霸王龙压制组', '无名资源', '采集网1080',  'videocdn', 'rezka', 'kinobase', 'collaps', 'cdnmovies', 'filmix', 'hdvb', 'videoapi']; // шаловливые ручки
