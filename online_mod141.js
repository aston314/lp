...
(function () {
    ...
    var extract_rule = {
      "rule": [
        ...
        {
          name: '欧乐影视',
          websitelink: 'https://www.oulevod.tv/',
          listlink: true,
          search_url: 'https://www.oulevod.tv/index.php/ajax/suggest?mid=1&wd=#msearchword&limit=1',
          search_json: true,
          node_json: 'list',
          name_json: 'name',
          id_json: 'id',
          ...
          detail_url_selector: 'ul.hl-plays-list',
          use_referer: false,
          js_execute_key: ['maccms', 'player_aaaa']
        },
        // {
    ...
    function web(component, _object, rule) {
      ...
      function dodetail(link, data, title) {
        //取得具体页面的详情地址
        network.silent(link, function (data) {
    ...
    function kunyu77(component, _object, rule) {
      ...
      this.search = function (_object, kinopoisk_id) {
        ...
        var url;
        kinopoisk_id === parseInt(kinopoisk_id, 10) ? url = cors_https + 'http://api.kunyu77.com/api.php/provide/videoPlaylist?ids=' + kinopoisk_id + 'devid=453CA5D864457C7DB4D0EAA93DE96E66&package=com.sevenVideo.app.android&pcode=010110004&sysver=9&model=OPPO%20R9tm&sys=android&version=1.8.7&brand=OPPO&sj=' + sj : url = cors_https + 'http://api.kunyu77.com/api.php/provide/searchVideo?searchName=' + encodeURIComponent(object.movie.title);
                  ...
                  if (json) {
                      ...
                      if (json.data.length !== 0) {
                          ...
                          if (json.data.length == 1) {
                              ...
                              url = cors_https + 'http://api.kunyu77.com/api.php/provide/videoPlaylist?ids=' + id + '&devid=453CA5D864457C7DB4D0EAA93DE96E66&package=com.sevenVideo.app.android&pcode=010110004&sysver=9&model=OPPO%20R9tm&sys=android&version=1.8.7&brand=OPPO&sj=' + sj;
                              // network.silent(url, function (json) {
                              //     if (json) {
                              //         if (json.data.episodes.length == 0) {
                              //             component.emptyForQuery(select_title)
