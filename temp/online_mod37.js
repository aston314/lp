//11.08.2022 - Add Chinese (simplified) language
...
(function () {
  ...
  var extract_rule = {
    ...
    // },
    {
        ...
        link_selector : '',
        link_folder : 'play',
        detail_url_selector : 'div.stui-pannel_bd.col-pd.clearfix',
        use_referer : false,
        js_execute_key : ['maccms','player_aaaa']
      },
    ]
                  ...
                  if (str) {
                    ...
                    //   };
                      ...
                      $.getMultiScripts(script_arr, url).done(function () {
                          ...
                          $(".noty").hide();
                          $.getScript(url + "/static/player/" + MacPlayer.PlayFrom + ".js")
                              .done(function () {
                                //$(".noty").show();
                    ...
                    //   $.when(
                    //       player_aaaa,
                    //       $.getScript(url + "/static/js/playerconfig.js"),
                    //       $.getScript(url + "/static/js/player.js"),
