...
(function () {
          ...
          item.on('hover:enter', function () {
            ...
            if (element.file) {
              ...
              if (!!window.cordova) {
                ...
                //console.log(proxy_url + element.file);
                ...
                //   iabRef.insertCSS({ code: 'body{position:fixed;top:0;left:0;margin:0;padding:0}' });
                // });

                iabRef.addEventListener('loadstop', function () {
                  // If the URL being loaded is a PDF
                  
                  // if (params.url.match(".mp4|.m3u8|video")) {
                  ...
                  iabRef.insertCSS({ code: '.dplayer-web-fullscreen-fix1{position:fixed;top:0;left:0;margin:0;padding:0}.MacPlayer { position:fixed;z-index:2147483649;left:0;top:0;width:100%!important;height:100%!important}' });
                  //iabRef.insertCSS({ code: '.MacPlayer { position:fixed;z-index:100000;left:0;top:0;width:100%!important;height:100%!important }' });
                  iabRef.executeScript({ code: `$("HMcoupletDivleft").remove();$("HMcoupletDivright").remove();document.body.classList.add("dplayer-web-fullscreen-fix1");` });
                  //iabRef.executeScript({code: '$(".MacPlayer").addClass("embed-responsive embed-responsive-16by9").css({position:fixed;z-index:100000;left:0;top:0;width:100%!important;height:100%!important});document.body.classList.add(".dplayer-web-fullscreen-fix1"),'});
                  // iabRef.executeScript(
                  //   {
                  //       file: "https://lf9-cdn-tos.bytecdntp.com/cdn/expire-1-M/jquery/3.5.1/jquery.min.js"
                  //       //webURL works fine with 'file'
                  //   }, function()
                  //   {
                  //     console.log('iabRef.executeScript jquery');
                  //     iabRef.executeScript(
                  //       {
                  //           code: `$(".MacPlayer").addClass("embed-responsive embed-responsive-16by9").css({position:fixed;z-index:100000;left:0;top:0;width:100%!important;height:100%!important});document.body.classList.add(".dplayer-web-fullscreen-fix1")`
                  //       }, function()
                  //       {
                  //           console.log('iabRef.executeScript done');
                  //       });
                  //   });
                    iabRef.show();
                });
    ...
    function component(object) {
      ...
      var filter_sources = ['找资源', '小纸条', '猫狸盘搜', '易搜', '霸王龙压制组', '无名资源', 'videocdn', 'rezka', 'kinobase', 'collaps', 'cdnmovies', 'filmix', 'hdvb', 'videoapi']; // шаловливые ручки
