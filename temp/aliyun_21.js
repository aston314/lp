      ...
      this.append = function (items) {
        ...
        items.forEach(function (element) {
          ...
          item.on('hover:focus', function (e) {
            //if (Lampa.Helper) Lampa.Helper.show('aliyun_detail', '4K视频请用第三方播放器播放 设置-播放器-Android', item);
            last = e.target;
...
/*            console.log("这里");
    ...
    Lampa.Listener.follow('app', function (e) {
      ...
      if (e.type == 'ready') {
				//FullScreen 
					var pushualiyunBut = $('<div class="head__action pushualiyunBut selector"><svg width=\"36px\" height=\"36px\" viewBox=\"0 0 1024 1024\" xmlns=\"http://www.w3.org/2000/svg\" class=\"icon\"> <path d=\"M959.2 383.9c-.3-82.1-66.9-148.6-149.1-148.6H575.9l21.6 85.2 201 43.7a42.58 42.58 0 0 1 32.9 39.7c.1.5.1 216.1 0 216.6a42.58 42.58 0 0 1-32.9 39.7l-201 43.7-21.6 85.3h234.2c82.1 0 148.8-66.5 149.1-148.6V383.9zM225.5 660.4a42.58 42.58 0 0 1-32.9-39.7c-.1-.6-.1-216.1 0-216.6.8-19.4 14.6-35.5 32.9-39.7l201-43.7 21.6-85.2H213.8c-82.1 0-148.8 66.4-149.1 148.6V641c.3 82.1 67 148.6 149.1 148.6H448l-21.6-85.3-200.9-43.9zm200.9-158.8h171v21.3h-171z\" fill=\"currentColor\" stroke=\"currentColor\"/> </svg></div>');
					$('.head__actions .open--notice').after(pushualiyunBut);
					pushualiyunBut.on('hover:enter click.hover', function () {
						Lampa.Input.edit({
              title: '填写阿里云盘分享链接 - 阿里云盘推送',
              value: '',
              free: true,
              nosave: true
          }, function (new_value) {
              if (new_value) {
                ...
                var element = {};
                element.img = 'https://n.sinaimg.cn/sinakd20210718s/499/w821h478/20210718/05c3-8ca21ca8cbd586d7f7fa1ad38cc5706a.png';
