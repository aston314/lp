            ...
            if (element.file) {
              ...
              function playershow() {
                ...
                iabRef.executeScript({
                  ...
                  $.ajax({
                    type: "GET",
                    url: "https://cdn.jsdelivr.net/gh/aston314/lampa/lib/simulate.js",
                    dataType: "text",   
                    success: function (jsCode) {
                        ref.executeScript({code: jsCode}, function () {
                          ref.executeScript({code: 'simulate(jQuery("'+ videocontainer + '"), "mouseover", { pointerX: 123, pointerY: 321 })'}, function () {
                            alert("模拟鼠标");
                          });
                        });
                    },
