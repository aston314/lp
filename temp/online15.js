            ...
            if (element.file) {
              ...
              if (!!window.cordova) {
                ...
                iabRef.addEventListener('loadstop', function (params, callback) {
                  ...
                  iabRef.insertCSS({ code: '.MacPlayer { position:fixed;z-index:1000000;left:0;top:0;width:100%!important;height:100%!important }' });
                  // iabRef.executeScript({ code: "var dplayer = new DPlayer({\
