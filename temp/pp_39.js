            ...
            //if (element.type == 'drive#folder') {
              ...
              network.silent('https://proxy.cub.watch/cdn/http://api.themoviedb.org/3/search/multi?api_key=45ddf563ac3fb845f2d5c363190d1a33&language=zh-CN&include_image_language=zh-CN,null,en&query=' + encodeURIComponent(chinese_title), function (json) {
                ...
                if (json.results.length > 0) {
                  //$(".files__title").append("<br/> <br/> 豆瓣："+rating_douban);
                  //$(".full-start__poster").after('<div class="card__type" style="left:1em;top:70">TMDB：' + json.results[0].vote_average.toFixed(1) + '</div>');
                  $(".full-start__img").after('<div class="card--new_ser" style="right: -0.6em;position: absolute;background: #168FDF;color: #fff;top: 0.8em;padding: 0.4em 0.4em;font-size: 1.2em;-webkit-border-radius: 0.3em;-moz-border-radius: 0.3em;border-radius: 0.3em;">TMDB：' + json.results[0].vote_average.toFixed(1) + '</div>');
