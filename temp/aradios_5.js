	...
	function radio_n(object) {
		...
		this.playing = function(ifs) {
			if (ifs == 'play') {
				...
				info.find('#plbut').replaceWith('<div id="plbut" class="controll selector play">'+stop_+'</div>');
			}
			else {
				audio.pause();
				info.find('.info__title-original').addClass('blink2');
				//info.find('#plbut').removeClass('pause').addClass('play');
				info.find('#plbut').replaceWith('<div id="plbut" class="controll selector play">'+play_+'</div>');
			};
		};
		this.build = function(data) {
			...
			Lampa.Template.add('info_radio', '<div class="radio_r info layer--width"><div class="info__left"><div class="info__title"></div><div class="info__title-original"></div><div class="info__create"></div></div><div class="info__right">   <div id="stantion_filtr"><div id="stbut" class="stbut full-start__button selector view--category"><svg style=\"enable-background:new 0 0 512 512;\" version=\"1.1\" viewBox=\"0 0 24 24\" xml:space=\"preserve\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\"><g id=\"info\"/><g id=\"icons\"><g id=\"menu\"><path d=\"M20,10H4c-1.1,0-2,0.9-2,2c0,1.1,0.9,2,2,2h16c1.1,0,2-0.9,2-2C22,10.9,21.1,10,20,10z\" fill=\"currentColor\"/><path d=\"M4,8h12c1.1,0,2-0.9,2-2c0-1.1-0.9-2-2-2H4C2.9,4,2,4.9,2,6C2,7.1,2.9,8,4,8z\" fill=\"currentColor\"/><path d=\"M16,16H4c-1.1,0-2,0.9-2,2c0,1.1,0.9,2,2,2h12c1.1,0,2-0.9,2-2C18,16.9,17.1,16,16,16z\" fill=\"currentColor\"/></g></g></svg><span>电台分类</span></div></div>    <div id="player_radio"><div id="plbut" class="controll selector play">'+play_+'</div></div>' + but_style + '</div></div>');
