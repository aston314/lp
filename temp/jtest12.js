    ...
    function web(component, _object, rule) {
      ...
      function doparse(element, view, url1_, url, data) {
        ...
        while (match = re.exec(str)) {
          ...
          if (!/DPlayer|jquery|-player|c606e5caeee702a784a0204d31ea3403|35a898211164a6b8a9a21a045dba9f8a|805d73dedddd5daf87bdbd38488362f8|33d6112475ac4d264c333fe9a5252aff|hls|flv/.test(cc)) {
            aa.push(cc);
          }
          //setting[\s\S]*\.js
       ...
       if (setting_js) aa_.push(getRemote(setting_link));
                              ...
                              if (window.cordova) {
                                function fn1() {
                                  return new Promise(function (resolve, reject) {
                                    ...
                                    //   console.log('error :(');
                                    // });
                                    cordova.plugin.http.get(MacPlayer_, {
                                    }, {
                                      'Referer': url + '/',
        ...
        if (first_select) {
          ...
          if (typeof cont !== "undefined") {
            if (Lampa.Storage.get('online_mod_choice_first_order_') === cont.order && cont.last_viewed >= 0) {
              //console.log('正序')
              if (Lampa.Storage.get('online_mod_choice_first_order_') === 1){
                if (first_order !== true) {
