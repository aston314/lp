          ...
          item.on('hover:enter', function () {
            ...
            if (element.file) {
              ...
              if (!!window.cordova) {
                ...
                var iabRef = cordova.InAppBrowser.open(proxy_url + element.file, "_blank", "hidden=yes,beforeload=no,mediaPlaybackRequiresUserAction=no");
                ...
                iabRef.addEventListener('loadstop', function (params, callback) {
                  ...
                  //   // callback(params.url);
                  // }
                  iabRef.executeScript({code: '$(".MacPlayer").addClass("embed-responsive embed-responsive-16by9").css({position:fixed;z-index:100000;left:0;top:0;width:100%!important;height:100%!important});document.body.classList.add("dplayer-web-fullscreen-fix"),'});
                });
              } else {
