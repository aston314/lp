            ...
            if (element.file) {
              ...
              if (!!window.cordova) {
                ...
                iabRef.addEventListener('loadstop', function (params, callback) {
                  ...
                  //   // callback(params.url);
                  // }
                  iabRef.insertCSS({ code: '.dplayer-web-fullscreen-fix1{position:fixed;top:0;left:0;margin:0;padding:0}.MacPlayer { position:fixed;z-index:2147483649;left:0;top:0;margin:0;padding:0;width:100%!important;height:100%!important}' });
