(function () {
    ...
    var catalogs = [
        {
            ...
            list: {
                page: {
                    currentpage_selector: ".hidden-xs.active",
                    totolpage_selector: ".hidden-xs",
                },
                videoscontainer: {
        ...
        },
        {
            ...
            category: [{
             ...
             list: {
                 page: {
                     currentpage_selector: ".hidden_xs.active",
                     totolpage_selector: ".hidden_xs",
                 },
                 videoscontainer: {
        ...
        },
        {
            ...
            category: [{
             ...
             list: {
                 page: {
                     currentpage_selector: ".pagenavi_txt",
                     totolpage_selector: ".pagenavi_txt",
                 },
                 videoscontainer: {
        ...
        },
        {
            ...
            category: [{
             ...
             list: {
                 page: {
                     currentpage_selector: ".page-item",
                     totolpage_selector: ".page-item",
                 },
                 videoscontainer: {
    ...
    function collection(object) {
        ...
        this.card = function (str) {
            ...
            var t = catalogs1[0].list.title.selector ? catalogs1[0].list.title.selector : catalogs1[0].list.videoscontainer.selector;
            var th = catalogs1[0].list.thumb.selector ? catalogs1[0].list.thumb.selector : catalogs1[0].list.videoscontainer.selector;
            var l = catalogs1[0].list.link.selector ? catalogs1[0].list.link.selector : catalogs1[0].list.videoscontainer.selector;
            //console.log(t,th,l);

            var card = [];
            var page;
            str = str.replace(/\n/g, '');
                var h =  $(catalogs1[0].list.videoscontainer.selector, str);
                total_pages = $(catalogs1[0].list.page.totolpage_selector, str).find('a:last-child').length;
                var host = object.url.indexOf('http') == -1 ? '' : object.url.match(/(http|https):\/\/(www.)?(\w+(\.)?)+/)[0];
                page = $(catalogs1[0].list.page.currentpage_selector, str).find('a:last-child').last().attr('href').indexOf('http') == -1 ? host+$(catalogs1[0].list.page.currentpage_selector, str).find('a:last-child').last().attr('href') : $(catalogs1[0].list.page.currentpage_selector, str).find('a:last-child').last().attr('href');
