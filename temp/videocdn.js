(function () {
    ...
    function component(object) {
      ...
      this.create = function () {
        ...
        url = Lampa.Utils.addUrlComponent(url, 'query=' + encodeURIComponent(object.search_two));
    ...
    function startPlugin() {
      ...
      Lampa.Listener.follow('full', function (e) {
        if (e.type == 'complite') {
          var btn = Lampa.Template.get('button_videocdn');
    ...
    if (!window.plugin_videocdn_ready) startPlugin();
