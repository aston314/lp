          ...
          item.on('hover:enter', function () {
            ...
            if (element.file) {
              ...
              if (!!window.cordova && doreg.videoparse == 'browser') {
                var iabRef = cordova.InAppBrowser.open(proxy_url + element.file, "_blank", "shouldPauseOnSuspend=yes,location=no,hidden=yes,beforeload=no,mediaPlaybackRequiresUserAction=no");
