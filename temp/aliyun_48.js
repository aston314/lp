  ...
  function component(object) {
                  ...
                  if (json) {
                    ...
                    if (file_id_json.code) {
                      ...
                      if (object.movie.img == './img/img_broken.svg') {
                        ...
                        network.silent('https://m.douban.com/search/?query=' + encodeURIComponent((file_id_json.file_infos[0].file_name.match(reg)[0] ? file_id_json.file_infos[0].file_name.match(reg)[0] : file_id_json.file_infos[0]).replace(/4K|《|【|》|】|\./g, ' ').match(reg)[0]), function (json) {
    ...
    Lampa.Listener.follow('app', function (e) {
      ...
      if (e.type == 'ready') {
          ...
          $('.settings-input__title').before($('<div style=\"width:80px\"><svg width=\"24px\" height=\"24px\" viewBox=\"0 0 24 24\" xmlns=\"http://www.w3.org/2000/svg\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\" class=\"feather feather-cast\"> <path d=\"M2 16.1A5 5 0 0 1 5.9 20M2 12.05A9 9 0 0 1 9.95 20M2 8V6a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2h-6\"></path> <line x1=\"2\" y1=\"20\" x2=\"2.01\" y2=\"20\"></line> </svg></div><div style=\"height:15px\"></div>'));
					});
			};
