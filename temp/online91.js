        ...
        items.forEach(function (element, item_id) {
          ...
          item.on('hover:enter', function () {
            ...
            if (element.file) {
              ...
              var iabRef = null;
              function playershow() {
                iabRef.insertCSS({ code: '.focus { border: 2px solid #0f0f0f;}.dplayer-web-fullscreen-fix1{position:fixed;top:0;left:0;margin:0;padding:0}' + videocontainer + ' { position:fixed;z-index:2147483649;left:0;top:0;width:50%!important;height:50%!important}' });
