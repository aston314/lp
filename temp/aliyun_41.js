              ...
              if (json) {
                if (getShareId === null) {
                  ...
                  if (object.movie.img == './img/img_broken.svg') {
                    ...
                    //   dataType: 'json'
                    // });
                    var chinese_title = object.movie.title.replace(/《|【|》|】|\./g, ' ').match(reg)[0];
                    network.silent('https://m.douban.com/search/?query=' + encodeURIComponent(chinese_title ? chinese_title : object.movie.title), function (json) {
