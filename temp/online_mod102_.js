...
(function () {
    ...
    function component(object) {
      ...
      var tg_sname = [];
      tg_resource.tg_channel.forEach(function (elem) {
      ...
      var filter_sources = ['找资源', '小纸条',  '酷云',  'videocdn', 'rezka', 'kinobase', 'collaps', 'cdnmovies', 'filmix', 'hdvb', 'videoapi']; // шаловливые ручки
